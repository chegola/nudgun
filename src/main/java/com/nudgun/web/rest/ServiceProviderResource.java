...
public class ServiceProviderResource {
    ...
    @Timed
    public ResponseEntity<List<ServiceProviderDTO>> getAllServiceProviders(ServiceProviderCriteria criteria, Pageable pageable) {
    ...
    /**
    * GET  /service-providers/count : count all the serviceProviders.
    *
    * @param criteria the criterias which the requested entities should match
    * @return the ResponseEntity with status 200 (OK) and the count in body
    */
    @GetMapping("/service-providers/count")
    @Timed
