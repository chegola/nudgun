...
export class ServiceProviderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.serviceProviderService
            ...
            .subscribe(
                (res: HttpResponse<IServiceProvider[]>) => this.paginateServiceProviders(res.body, res.headers),
    ...
    trackId(index: number, item: IServiceProvider) {
        return item.id;
    }
    ...
    protected paginateServiceProviders(data: IServiceProvider[], headers: HttpHeaders) {
